...
const BirthdayWelcomePage = () => {
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500">
      {/* Canvas Confetti Background */}
      <Confetti />
      
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-pink-600/20 animate-pulse z-10"></div>
      ...
      <div className="relative z-30 flex flex-col items-center justify-center h-screen p-8">
        {/* Countdown Timer */}
        ...
        <div className="relative transform hover:scale-105 transition-all duration-300 animate-pulse">
          ...
          {/* Main Container */}
          <div className="relative bg-white/10 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl max-w-2xl mx-auto">
            {/* Birthday Text */}
